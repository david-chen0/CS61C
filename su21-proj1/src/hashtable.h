...
/*
 * Helper method for insertData where it puts newBucket's key and data.
 * Then appends it to the linked list (HashBucket)
 */
extern void helperAppendData(HashBucket **currBucket, HashBucket **newBucket, void *key, void *data);
